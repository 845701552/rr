...
def get_data8_val734():
    ...
    print("pred734:" + str(pred734.shape[0]))
...
def grid_rf(X,y):
    ...
    auc_roc0.8704383983675242
    {'min_samples_leaf': 2, 'min_samples_split': 5}
    auc_roc0.8710394317925485

    """
    params={# 'n_estimators':[50,100,300,500,800,1000],
            #'max_depth': range(3, 14, 2),
          #'max_features': range(3, 8, 2),
          #"class_weight":[{0: 1, 1:6},{0: 1, 1:8},{0: 1, 1:10},{0: 1, 1:50},{0: 1, 1:20},{0: 1, 1:30},{0: 1, 1:40}],
